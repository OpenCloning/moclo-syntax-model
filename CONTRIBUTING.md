# Contributing to moclo-syntax-model

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
moclo-syntax-model. These guidelines are not strict rules.
...
The moclo-syntax-model team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the moclo-syntax-model technical leads
...
[issues]: https://github.com/OpenCloning/moclo-syntax-model/issues/
[pulls]: https://github.com/OpenCloning/moclo-syntax-model/pulls/
